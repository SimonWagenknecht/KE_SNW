// Diese Datei wurde automatisch am : 30.03.2017 um 09:24:55 generiert und entspricht der Systemversion nach 04.09.2012 13:47:53!!!
...
const Pgrup so1[] = { 
	...
	{"*->;"," DREHZAHL IST   "," 1/min ", P&modb_data[PU_BUS_SOL - 1].input_reg5, 	US_INT,  0, P&wilo1,V0, 0, IDX0_FELD},
	{"*->;"," DIFFERENZDRUCK "," mWS   ", P&modb_data[PU_BUS_SOL - 1].input_reg0, 	US_INT,	 1, P&wilo1,V0, 0, IDX0_FELD},
	{"*->;"," FOERDERSTROM   "," m/h  ", P&modb_data[PU_BUS_SOL - 1].input_reg1, 	US_INT,	 1, P&wilo1,V0, 0, IDX0_FELD},
	...
	{"*->;"," DREHZAHL IST   "," 1/min ", P&modb_data[PU_BUS_PUF - 1].input_reg5, 	US_INT,  0, P&wilo2,V0, 0, IDX0_FELD},
	{"*->;"," DIFFERENZDRUCK "," mWS   ", P&modb_data[PU_BUS_PUF - 1].input_reg0, 	US_INT,	 1, P&wilo2,V0, 0, IDX0_FELD},
	{"*->;"," FOERDERSTROM   "," m/h  ", P&modb_data[PU_BUS_PUF - 1].input_reg1, 	US_INT,	 1, P&wilo2,V0, 0, IDX0_FELD},
