...
//	{" 67;"," FAKTOR ABSENK. ","       ", P&hks[HK1].AbsenkFaktor,	US_INT, 2, P&hid1,	V2, 0, 0},	06.01.2017
	...
	{"*->;"," DREHZAHL IST   "," 1/min ", P&modb_data[PU_BUS_HK1 - 1].input_reg5, 	US_INT,  0, P&wilo3,V1, 0, IDX0_FELD},
	{"*->;"," DIFFERENZDRUCK "," mWS   ", P&modb_data[PU_BUS_HK1 - 1].input_reg0, 	US_INT,	 1, P&wilo3,V1, 0, IDX0_FELD},
	{"*->;"," FOERDERSTROM   "," m/h  ", P&modb_data[PU_BUS_HK1 - 1].input_reg1, 	US_INT,	 1, P&wilo3,V1, 0, IDX0_FELD},
