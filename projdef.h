...
#define HKANZ				2							// projektierte Anzahl von Heizkreisen
#define HKMAX				2							// maximale Anzahl (wegen Speicherzuweisung mindestens 1)
...
// Einstellung für Parli: hk2[] NahwärmeNetz
#define TRLBEG_HK2	1							// Rücklauftemperaturbegrenzung
...
#define STW_HK2			1							// STW-ALARM
#define PUAL_HK2		0							// Pumpenalarm
#define PUBM_HK2		1							// Betriebsmeldung Pumpe
...
#define PULZ_HK2		1							// Pumpenlaufzeit berechnen und anzeigen ( parli, steuer.c, 
...
#define PU_BUS_HK2	4							// ungleich 0: Pumpe busgesteuert, Wert = Parameter-Index bei Solar nicht verändern!!!	
...
// ***AnFre
#define PRANZ				0							// projektierte Anzahl der Profile
...
#define ZPU_WW1			0							// 1 = Zirkulationspumpe vorhanden																	
...
#define TPU_WW1			0							// 1 = Tauscherpumpe vorhanden
...
#define ZE5					0	
#define ZE6					0	
#define ZE7					0	//  Vol.geber 	KWZ: KaltWasser -Zähler	
#define ZE8					1	//	"				"		WZ1: Kessel	
#define ZE9					1	//  "				"		WZ2: Solar
#define ZE10				1	//  "				"		WZ3: Netzheizkreis
